...
class RegistrarUsuarioViewController: UIViewController {
    ...
    @IBAction func btnRegistrarseTap(_ sender: UIButton){
        ...
        Utiles.limpiarCampos(campos: camposTxt)
        //Ejecutar instruccion de registrar usuario
        service.registrar(nombre: nombre, apellido: apellido, dni: dni, email: email, password: password)
        //Al registrarse se manda a iniciar sesion
